  ...
  return (
    <div className="w-full max-w-[600px] mx-auto bg-white text-gray-800 shadow-2xl rounded-2xl overflow-hidden relative border border-gray-200 font-sans select-none flex flex-col">
      ...
      >
        ...
        {/* Content Section (Middle) - Shifted right with extra left padding to avoid decorative pillar artwork */}
        <div className="pl-14 sm:pl-20 pr-6 sm:pr-14 pt-4 pb-2 flex-1 flex flex-col justify-start text-gray-800 leading-relaxed font-sans text-xs sm:text-sm text-left">
  ...
  <div class="card-container">
    ...
    <div class="bg-wrapper" style="background-image: url('${finalBgImageUrl}');">
      ...
      <div class="content-body" style="color: #1e293b !important; text-align: left;">
        ...
        ${quote ? `<div class="paragraph" style="color: #334155 !important; text-align: left;">${renderDynamicTextHTML(quote, contextVars)}</div>` : ''}
